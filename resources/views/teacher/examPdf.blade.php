...
<head>
  ...
  <title>Exam Pdf | TechSolve</title>
  <!-- Bootstrap 5 CSS -->
...
<body>
  ...
  <main class="main-content">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
      <div>
        <h1 class="h3 mb-1"><i class="bi bi-upload"></i> Upload Exam Paper PDF</h1>
        
      </div>
      <div>
        <form method="GET" action="">
          <input type="text" name="search" class="form-control" placeholder="Search exam paper...">
        </form>
      </div>
    </div>
    ...
    <div class="announcement-form">
      <h4 class="mb-3">Upload New Exam Pdf</h4>
       <br>
       @if(session('success'))
       <h5 class="alert alert-success" style="background:#fff; color:green;">{{session('success')}}</h5>
       @endif

      <form class="form-control"  action="{{route('teacher.examPaper')}}" method="POST" enctype="multipart/form-data">
         @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
         ...
         <button type="submit" class="btn-post"><i class="bi bi-upload"></i> Upload Pdf</button>
      </form>
    </div>
